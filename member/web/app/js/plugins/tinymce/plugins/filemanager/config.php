...
$base_url="http://kygui.com"; //url base of site if you want only relative url leave empty
$upload_dir = '/angular/public/source/'; // path from base_url to upload base dir
