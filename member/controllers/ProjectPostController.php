...
class ProjectPostController extends ApiController {
    ...
    public function actionAddProjectPost() {
        try {
            ...
            $projectParticipants = ProjectParticipant::findAll(['company_id' => \Yii::$app->user->getCompanyId(), 'project_id' => $projectInfo->id]);
            ...
            $employees = Employee::find()->andCompanyId()->andWhere(['id' => $employeeIds])->orWhere(['department_id' => $departmentIds])->all();
