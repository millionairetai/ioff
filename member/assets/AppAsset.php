...
//        'app/js/plugins/knob/jquery.knob.js',
        'app/js/plugins/knob/d3.min.js',
        'app/js/plugins/knob/ng-knob.min.js',
        'app/js/plugins/angular-chart/Chart.min.js',
        'app/js/plugins/angular-chart/angular-chart.js',
        'app/app.js',
        'app/router.js',
