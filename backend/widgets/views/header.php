                        ...
                        <li class="user-footer">
                            ...
                            <div class="pull-right">
                                <!--                                <form action="/index.php?r=site/logout" method="post">
                                                                    <input type="hidden" name="_csrf" value="RjRPVjJTR3cofA08dQNzQC9BJTtiMD4OdmcWP3h.HRkpBnpkVAp0Pg==">
                                                                    <button type="submit" class="btn btn-link">Logout (millionairetai)</button>
                                                                </form>-->
                                <?php
                                ...
                                . Html::endForm()
                                ?>
                                <!--<a href="/index.php?r=site%2Flogout" class="btn btn-default btn-flat">Sign out</a>-->
                            </div>
                        </li>
                    </ul>
                </li>
