...
<!--                    <span class="progress-description">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">Tăng so với tháng trước</span>
        ...
        <div class="col-md-8">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Tổng quan hệ thống</h3>
...
<!--                    <form role="form" class="form-horizontal">
                    ...
                    <a class="pull-right" href="/company/report">Xem chi tiết</a>
                    <h4>Dung lương lưu trữ</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <h4>Công ty & người dùng</h4>
                            <h5><?= $dashboard['company_overview']['total_company']; ?> công ty</h5>
                            <ul>
                            ...
                            <b>Total: <?= $dashboard['company_overview']['total_user']; ?> người dùng</b>
                        </div>
                    </div>
                </div><!-- /.box-body -->
            </div><!-- /.box -->
...
<!--                    <form role="form" class="form-horizontal">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Doanh số mỗi nhân viên</h3>
                    <div class="box-tools pull-right">
                        <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                        <button class="btn btn-box-tool" data-widget="remove" data-toggle="tooltip" title="Remove"><i class="fa fa-times"></i></button>
                    </div>
        ...
        <div class="col-md-4 padding-left-md-0">
            <?php if (!empty($dashboard['right_bar_company']['recently_company'])): ?>
                <div class="box box-widget">
                    <div class="box-header with-border">
                        <h3 class="box-title">Công ty mới</h3>
                        <div class="box-tools pull-right">
                    ...
                    <div class="box-footer text-center">
                        <a href="/company/index" class="uppercase">Xem tất cả</a>
                    </div>
                </div>
            <?php endif; ?>
            <?php if (!empty($dashboard['right_bar_company']['duedate_company'])): ?>
                <div class="box box-widget">
                    <div class="box-header with-border">
                        <h3 class="box-title">Công ty hết hạn</h3>
                        <div class="box-tools pull-right">
                            <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                            </button>
                        </div>
