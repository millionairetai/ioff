    ...
    <section class="invoice">
        ...
        <div class="row invoice-info">
            <div class="col-sm-4 invoice-col">
                Từ
                <address>
                    <strong><?= $invoiceInfo['service_from']; ?></strong><br>
            ...
            <div class="col-sm-4 invoice-col">
                Đến
                <address>
                    <strong><?= $invoiceInfo['company_name_to']; ?></strong><br>
                    <?= $invoiceInfo['address_to']; ?><br>
                    <!--                    San Francisco, CA 94107<br>-->
                    Điện thoại: <?= $invoiceInfo['commpany_phone_to']; ?><br>
            ...
            <div class="col-sm-4 invoice-col">
                ...
                <br>
                <b>Số hóa đơn:</b> <?= $invoiceInfo['invoice_no']; ?><br>
...
<!--                            <tr>
        ...
        <div class="row no-print">
            <div class="col-xs-12">
                ...
                <a href="/invoice/payment-history?id=<?= $companyId ?>" class="btn btn-default pull-left"><i class="fa fa-backward"></i> Quay lại</a>
