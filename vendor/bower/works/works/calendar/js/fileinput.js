...
//    '</div>';
    ...
    tText = '<div class="file-preview-frame{frameClass}" id="{previewId}" data-fileindex="{fileindex}">\n' +
    '   {caption} ' +
    '   <button type="button" class="kv-file-remove button_no_background {removeClass}" title="{removeTitle}" {dataUrl}{dataKey}><i class="glyphicon glyphicon-trash text-danger"></i></button>\n\n' +
    '</div>';
