...
<div class="container">
    <ol class="breadcrumb">
        <li><a href="/">Home</a></li>
        <li class="active"><?= Yii::t('common', 'Contact'); ?></li>
    </ol>
</div>
...
<!--                    <div class="form-group">
                ...
                <?= $form->field($model, 'name')->textInput(['placeholder' => Yii::t('common', 'Name'), 'autofocus' => true, 'class' => 'form-control noround']) ?>
                                
                <?= $form->field($model, 'email')->textInput(['placeholder' => Yii::t('common', 'Email'), 'class' => 'form-control noround']) ?>

                <?= $form->field($model, 'subject')->textInput(['placeholder' => Yii::t('common', 'Subject'), 'class' => 'form-control noround']) ?>

                <?= $form->field($model, 'body')->textArea(['placeholder' => Yii::t('common', 'Body'), 'rows' => 6, 'class' => 'form-control noround']) ?>

                <?= $form->field($model, 'phone')->textInput(['placeholder' => Yii::t('common', 'Phone'), 'class' => 'form-control noround']) ?>
...
<div class="form-group">-->
                    <?= Html::submitButton('Submit', ['class' => 'btn btn-primary noround', 'name' => 'contact-button']) ?>
                </div>
