    ...
    public static function getInfoProject($projectId) {
        ...
        return [
            'project_info' => [
                ...
                'start_datetime' => !empty($project->start_datetime) ? date('Y-m-d', $project->start_datetime) : null,
                'duedatetime' => !empty($project->duedatetime) ? date('Y-m-d', $project->duedatetime) : null,
